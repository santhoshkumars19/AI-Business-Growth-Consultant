  ...
  const SidebarContent = () => (
    <>
      ...
      <div style={{
        ...
        {/* Name + business — hidden when collapsed */}
      ...
      <nav style={{ flex: 1, padding: '10px 8px', overflowY: 'auto', overflowX: 'hidden' }}>
        ...
        {/* Extra links */}
        <Link href="/features/pdf-export" className={`nav-link ${pathname === '/features/pdf-export' ? 'active' : ''}`} style={{ marginBottom: 3 }}>
          <span className="nav-icon">📄</span>
          <span className="nav-label">Download Report</span>
        </Link>
        <Link href="/admin/users" className={`nav-link ${pathname.startsWith('/admin') ? 'active' : ''}`} style={{ marginBottom: 3 }}>
